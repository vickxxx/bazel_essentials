DEPS = {
    ...
    #
    # NOTE(yi.sun): We cannot upgrade to protobuf 3.3.1 as the generated code
    # does not work with the very old GRPC version.
    ...
    # This binds the cc_binary "protoc" into //external:protoc. Required by
    # grpc++.
    "protoc": {
        "rule": "bind",
